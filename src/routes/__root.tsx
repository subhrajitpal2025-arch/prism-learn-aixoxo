...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OrbitEdu — Learn. Evolve. Excel." },
      ...
      { name: "author", content: "OrbitEdu" },
      { property: "og:title", content: "OrbitEdu — Learn. Evolve. Excel." },
      ...
      { name: "twitter:title", content: "OrbitEdu — Learn. Evolve. Excel." },
